...
- **Uninstall:** `/plugin uninstall no-surprises@no-surprises` (or remove it from the `/plugin` manager).
- **Remove the marketplace:** `/plugin marketplace remove no-surprises`.
